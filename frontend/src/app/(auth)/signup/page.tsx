  ...
  return (
    <div className="w-full max-w-sm">
      ...
      <div className="bg-white rounded-2xl border border-slate-200 shadow-sm px-8 py-8">
        ...
        <p className="text-slate-500 text-sm mb-6">Join DEEPSIAN</p>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            ...
            <select
              ...
              className="w-full px-3.5 py-2.5 border border-slate-200 rounded-lg text-sm text-slate-900 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition bg-white"
            >
